...
var _require2 = require('yargs/helpers'),
    hideBin = _require2.hideBin;

var debug = require('../../debug').default;

var getUrlHeaders = require('../../util/getUrlHeaders');

var _require3 = require('../config/reinitializePluginConfigs'),
    tryInitializePluginConfigs = _require3.tryInitializePluginConfigs;
...
module.exports = /*#__PURE__*/function () {
  var _deployApiActions = _asyncToGenerator(function* (args, context) {
    ...
    var flags = yargs(hideBin(args.argv || process.argv).slice(2)).option('dataset', {
      type: 'string'
    }).option('tag', {
      type: 'string',
      default: 'default'
    ...
    var force = flags.force,
        ...
        nonNullDocumentFields = flags.nonNullDocumentFields;
