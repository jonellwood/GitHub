...
var InnerAutocomplete = react_1.forwardRef(function (props, ref) {
    var _a = props.border, border = _a === void 0 ? true : _a, filterOptionProp = props.filterOption, _b = props.fontSize, fontSize = _b === void 0 ? 2 : _b, icon = props.icon, id = props.id, loading = props.loading, onChange = props.onChange, onQueryChange = props.onQueryChange, onSelect = props.onSelect, openButton = props.openButton, _c = props.options, optionsProp = _c === void 0 ? [] : _c, _d = props.padding, paddingProp = _d === void 0 ? 3 : _d, _e = props.radius, radius = _e === void 0 ? 2 : _e, renderOptionProp = props.renderOption, _f = props.renderValue, renderValue = _f === void 0 ? defaultRenderValue : _f, _g = props.value, valueProp = _g === void 0 ? '' : _g, restProps = __rest(props, ["border", "filterOption", "fontSize", "icon", "id", "loading", "onChange", "onQueryChange", "onSelect", "openButton", "options", "padding", "radius", "renderOption", "renderValue", "value"]);
    ...
    var _h = react_1.useState(valueProp), value = _h[0], setValue = _h[1];
    var _j = react_1.useState(null), query = _j[0], setQuery = _j[1];
    var valueRef = react_1.useRef(value);
    var _k = react_1.useState(false), focused = _k[0], setFocused = _k[1];
    var listboxId = id + "-listbox";
    var options = Array.isArray(optionsProp) ? optionsProp : [];
    var _l = react_1.useState(-1), selectedIndex = _l[0], setSelectedIndex = _l[1];
    var inputRef = react_1.useRef(null);
    var listRef = react_1.useRef(null);
    var activeItemId = selectedIndex > -1 ? id + "-option-" + selectedIndex : undefined;
    var padding = styles_1.getResponsiveProp(paddingProp);
    var rootRef = react_1.useRef(null);
    var currentOption = value ? options.find(function (o) { return o.value === value; }) : undefined;
    var filteredOptions = options.filter(function (option) { return (query ? filterOption(query, option) : true); });
    ...
    return (react_1.default.createElement(styles_2.Root, { "data-ui": "Autocomplete", onBlur: handleRootBlur, onKeyDown: handleRootKeyDown, ref: rootRef },
        ...
        react_1.default.createElement(styles_2.ListBoxContainer, { hidden: !expanded },
            react_1.default.createElement(styles_2.ListBoxCard, { paddingY: 1, radius: 1, shadow: 2, tabIndex: -1, tone: "inherit" },
                ...
                react_1.default.createElement(styles_2.LoadingCard, { padding: 3, style: { opacity: loading ? 0.5 : 0 } },
