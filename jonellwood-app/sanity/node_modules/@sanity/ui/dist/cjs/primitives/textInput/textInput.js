...
exports.TextInput = react_1.forwardRef(function (props, forwardedRef) {
    ...
    return (react_1.default.createElement(Root, { "data-ui": "TextInput" },
        prefix && (react_1.default.createElement(Prefix, { borderTop: true, borderLeft: true, borderBottom: true, radius: radius, sizing: "border" },
            react_1.default.createElement("span", null, prefix))),
        react_1.default.createElement(InputRoot, null,
            react_1.default.createElement(Input, __assign({ "data-as": "input" }, restProps, { "$iconLeft": Boolean(icon), "$iconRight": Boolean(iconRight) || Boolean(clearButton), "$padding": padding, "$space": space, "$fontSize": fontSize, disabled: disabled, ref: ref, type: type })),
            react_1.default.createElement(Presentation, { "$border": border, "$hasPrefix": Boolean(prefix), "$hasSuffix": Boolean(suffix), "$radius": radius },
                ...
                !clearButton && iconRight && (react_1.default.createElement(RightBox, { padding: padding },
                    react_1.default.createElement(text_1.Text, { size: fontSize },
                        react_1.isValidElement(iconRight) && iconRight,
                        react_is_1.isValidElementType(iconRight) && react_1.createElement(iconRight))))),
            clearButton && (react_1.default.createElement(RightBox, { padding: padding.map(function (v) { return v - 2; }), style: { zIndex: 2 } },
                react_1.default.createElement(button_1.Button, __assign({}, (typeof clearButton === 'object' ? clearButton : {}), { "data-qa": "clear-button", fontSize: fontSize, icon: icons_1.CloseIcon, mode: "bleed", onClick: handleClearClick, onMouseDown: handleClearMouseDown, padding: padding.map(function (v) { return v - 1; }) }))))),
        suffix && (react_1.default.createElement(Suffix, { borderTop: true, borderRight: true, borderBottom: true, radius: radius, sizing: "border" },
