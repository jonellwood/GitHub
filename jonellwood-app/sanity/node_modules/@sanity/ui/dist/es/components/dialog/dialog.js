...
export const Dialog = forwardRef((props, ref) => {
    const { cardRadius = 3, cardShadow = 4, children, contentRef, footer, header, id, onClose, padding = 4, position = 'fixed', scheme, width = 0 } = props, restProps = __rest(props, ["cardRadius", "cardShadow", "children", "contentRef", "footer", "header", "id", "onClose", "padding", "position", "scheme", "width"]);
    ...
    return (React.createElement(Portal, null,
        React.createElement(Root, Object.assign({}, restProps, { "$padding": padding, "$position": position, "aria-labelledby": labelId, "aria-modal": true, "data-ui": "Dialog", id: id, onFocus: handleFocus, ref: ref, role: "dialog" }),
            ...
            React.createElement(DialogCard, { contentRef: contentRef, footer: footer, header: header, id: id, onClose: onClose, radius: cardRadius, ref: cardRef, scheme: scheme, shadow: cardShadow, width: width }, children),
