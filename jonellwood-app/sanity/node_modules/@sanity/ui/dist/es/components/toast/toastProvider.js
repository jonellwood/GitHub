...
`;
let toastId = 0;
export function ToastProvider({ children, padding = 4, paddingX, paddingY, zOffset, }) {
    ...
    const push = useCallback((params) => {
        ...
        setState((prevState) => {
            return Object.assign(Object.assign({}, prevState), { toasts: prevState.toasts
                    .filter((t) => t.id !== id)
                    .concat([
                    {
                        dismiss,
    ...
    return (React.createElement(ToastContext.Provider, { value: { push } },
        children,
        React.createElement(Root, { "data-ui": "ToastProvider", zOffset: zOffset },
            React.createElement(ToastContainer, null,
                React.createElement(Box, { padding: padding, paddingX: paddingX, paddingY: paddingY },
